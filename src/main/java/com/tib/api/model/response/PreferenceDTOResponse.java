...
public class PreferenceDTOResponse extends CustomAPIResponse {
    ...
    public PreferenceDTOResponse(Error[] errors, boolean hasError, String messages, Integer noOfPendingBoarding, Integer noOfActiveBoarding) {
        super(errors, hasError, messages);
        this.noOfPendingBoarding = noOfPendingBoarding;
        this.noOfActiveBoarding = noOfActiveBoarding;
    }

    public PreferenceDTOResponse(APIResponse apiResponse) {
        super(apiResponse);
    ...
    public boolean equals(Object o) {
        ...
        PreferenceDTOResponse that = (PreferenceDTOResponse) o;
