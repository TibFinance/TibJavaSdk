...
public class GetFreeCollectionOperationsArgs  extends BaseAuthenticatedCryptedArgs  {
 ...
 */
    ...
    public GetFreeCollectionOperationsArgs() {
    }

    
    public GetFreeCollectionOperationsArgs(LocalDateTime fromDate, LocalDateTime toDate, String transferGroupId, boolean onlyWithErrors, String merchantId, String serviceId) {
...
this.serviceId = serviceId;
    ...
    public GetFreeCollectionOperationsArgs(String sessionToken, LocalDateTime fromDate, LocalDateTime toDate, String transferGroupId, boolean onlyWithErrors, String merchantId, String serviceId) {
        super(sessionToken);
        this.fromDate = fromDate;
this.toDate = toDate;
this.transferGroupId = transferGroupId;
...
this.serviceId = serviceId;
    ...
    public boolean equals(Object o) {
        ...
        GetFreeCollectionOperationsArgs that = (GetFreeCollectionOperationsArgs) o;
    ...
    public String toString() {
        return "GetFreeCollectionOperationsArgs{" +
                 "fromDate='" + fromDate + '\'' +
 ", toDate='" + toDate + '\'' +
