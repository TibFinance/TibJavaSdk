...
public class GetLoginAccesListArgs  implements IBaseCryptedServiceArgs  {
    ...
    public GetLoginAccesListArgs() {
    }

    
    public GetLoginAccesListArgs(String clientId, String username, String password) {
    ...
    public boolean equals(Object o) {
        ...
        GetLoginAccesListArgs that = (GetLoginAccesListArgs) o;
